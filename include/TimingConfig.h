...
#define ENCODER_HOLD_DURATION_MS 2000 // Long press duration
...
#define DENIAL_MESSAGE_DURATION_MS 2000 // How long denial/error messages remain visible on screen
